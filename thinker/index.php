...
<?php include_once "parts/header.php"?>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <?php 
                        $json_text = file_get_contents("json/text.json");
                        $data_text = json_decode($json_text, true);

                        $json_image = file_get_contents("json/img.json");
                        $data_image = json_decode($json_image, true);
                        $i = 0;
                        echo('
                                                
                        <div class="icon">
                            <img src='.$data_image[1]["service1"].' alt="">
                        </div>
                        <h4>Smart Notifications</h4>
                        <div class="line-dec"></div>
                        <p>'.$data_text[$i++]["text"].'</p>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src='.$data_image[1]["service2"].' alt="">
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src='.$data_image[1]["service3"].' alt="">
                        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <div class="icon">
                            <img src='.$data_image[1]["service4"].' alt="">
                        </div>
                            ...
                            <div class="projects-holder">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href='.$data_image[3]["portfolio1"].' data-lightbox="image-1"><img src='.$data_image[4]["portfolio1"].'></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href='.$data_image[3]["portfolio2"].' data-lightbox="image-1"><img src='.$data_image[4]["portfolio2"].'></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href='.$data_image[3]["portfolio3"].' data-lightbox="image-1"><img src='.$data_image[4]["portfolio3"].'></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href='.$data_image[3]["portfolio4"].' data-lightbox="image-1"><img src='.$data_image[4]["portfolio4"].'></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href='.$data_image[3]["portfolio5"].' data-lightbox="image-1"><img src='.$data_image[4]["portfolio5"].'></a>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 project-item mix nature">
                                      <div class="thumb">
                                            <div class="image">
                                                <a href='.$data_image[3]["portfolio6"].' data-lightbox="image-1"><img src='.$data_image[4]["portfolio6"].'></a>
                                            </div>
                                      </div>
                                    </div>
                                </div>
    ...
    <div id="map">
        ...
        -->
        <?php include_once "parts/goomaps.htm"?>
    </div>
